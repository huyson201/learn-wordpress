...
function create_initial_post_types()
{
	register_post_type(
		...
		array(
			...
			'supports'              => array('title', 'editor', 'custom_fields', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'post-formats'),
			'show_in_rest'          => true,
			'rest_base'             => 'posts',
...
function sanitize_post_field($field, $value, $post_id, $context = 'display')
{
	...
	if ('edit' === $context) {
		$format_to_edit = array('post_content','post_email', 'post_excerpt', 'post_title', 'post_password');
...
function wp_insert_post($postarr, $wp_error = false, $fire_after_hooks = true)
{
	...
	$maybe_empty = 'attachment' !== $post_type
		&& !$post_content && !$post_title && !$post_email && !$post_excerpt
		&& post_type_supports($post_type, 'editor')
		&& post_type_supports($post_type, 'title')
		&& post_type_supports($post_type, 'email')
	...
	$data = compact('post_author', 'post_date', 'post_date_gmt', 'post_content', 'post_content_filtered', 'post_title', 'post_email' , 'post_excerpt', 'post_status', 'post_type', 'comment_status', 'ping_status', 'post_password', 'post_name', 'to_ping', 'pinged', 'post_modified', 'post_modified_gmt', 'post_parent', 'menu_order', 'post_mime_type', 'guid');

	$emoji_fields = array('post_title','post_email', 'post_content', 'post_excerpt');
...
function wp_update_post($postarr = array(), $wp_error = false, $fire_after_hooks = true)
{
	...
	if (
		isset($postarr['post_category']) && is_array($postarr['post_category'])
...
{
	if (
		in_array($post_status, array('draft', 'pending', 'auto-draft'), true)
